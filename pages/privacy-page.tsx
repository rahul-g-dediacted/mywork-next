      ...
      <div className="max-w-2xl px-2 py-12">
        ...
        <div className="text-justify">
          <div className="mb-16">
            ...
            <p>
              In this Privacy Policy, 'us' 'we' or 'our' means MOONLIGHT21 PTE.
              LTD. (202132888E) . We are committed to respecting your privacy.
              Our Privacy Policy sets outs out how we collect, use, store and
              disclose your personal information. By providing personal
              information to us, you consent to our collection, use and
              disclosure of your personal information in accordance with this
              Privacy Policy and any other arrangements that apply between us.
              We may change our Privacy Policy from time to time by publishing
              changes to it on our website. We encourage you to check our
              website periodically to ensure that you are aware of our current
              Privacy Policy.
            </p>
          </div>
          ...
          <div className="mb-16">
            ...
            <ol className="list-decimal pl-4 mb-4">
              <li className="mb-2">
                your device ID, device type, geo-location information, phone or
                mobile device and connection information, statistics on page
                views, traffic to and from the sites, ad data, IP address and
            ...
            <p>
              ...
              directly through our website or app or indirectly through your use
              of our website or app or online presence or through other websites
              or accounts from which you permit us to collect information;
              information you provide to us through customer surveys; or any
          ...
          <div className="mb-16">
            ...
            <ol className="list-decimal pl-4 mb-4">
              <li className="mb-2">register on our website or app;</li>
              <li className="mb-2">
              ...
              <li className="mb-2">
                invest in our business or enquire as to a potential purchase in
                our business.
              </li>
            </ol>
            <p>
              ...
              practices in relation to employee records of our current and
          ...
          <div className="mb-16">
            ...
            <ul>
              ...
              <li className="mb-2">to consider your employment application.</li>
            </ul>
            <p>
          ...
          <div className="mb-16">
            ...
            <p>
              Traditionally, cookies and information obtained from cookies are
              not treated as personal information if they cannot identify an
              individual. However, with the increasing complexity of cookies and
              the data that may be collected by cookies, some cookies and the
              data collected may qualify as personal information. Please
              consider whether any cookies that your company uses will collect
              personal information.We may collect personal information about you
              when you use and access our website. While we do not use browsing
              information to identify you personally, we may record certain
              information about your use of our website, such as which pages you
          ...
          <div className="mb-16">
            <h1 className="text-3xl tracking-wide font-semibold mb-4">Media</h1>
            <p>
